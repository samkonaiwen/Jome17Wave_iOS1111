//
//  LastGroupsViewController.swift
//  Jome17Wave_iOS
//
...
class LastGroupsViewController: UIViewController {
    ...
    struct PropertyKeys {
        static let lastGroupsCell = "GroupListTableViewCell"
...
extension LastGroupsViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: PropertyKeys.lastGroupsCell, for: indexPath) as! GroupListTableViewCell
        let group = lastGroups[indexPath.row]
